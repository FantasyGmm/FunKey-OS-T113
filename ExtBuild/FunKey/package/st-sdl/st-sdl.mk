...
define ST_SDL_BUILD_CMDS
	(cd $(@D); \
	sed -i -e 's|/opt/FunKey-sdk-2.0.0|$(HOST_DIR)|g' config_funkey-s.mk; \
	sed -i -e 's|arm-funkey-linux-musleabihf-|$(BR2_TOOLCHAIN_EXTERNAL_CUSTOM_PREFIX)-|g' config_funkey-s.mk; \
	sed -i -e 's|../../host/arm-funkey-linux-musleabihf/sysroot|$(HOST_DIR)/arm-buildroot-linux-gnueabihf/sysroot|g' config_funkey-s.mk; \
	make \
	)
endef
...
define ST_SDL_CREATE_OPK
	...
	mksquashfs $(ST_SDL_PKGDIR)/opk $(TARGET_DIR)/usr/local/share/OPKs/Applications/st-sdl_funkey-s.opk -all-root -noappend -no-exports -no-xattrs
endef
