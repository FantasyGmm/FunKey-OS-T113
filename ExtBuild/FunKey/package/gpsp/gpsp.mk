...
GPSP_DEPENDENCIES = sdl sdl_image sdl_mixer sdl_ttf zlib libini
...
define GPSP_CREATE_OPK
	...
	mksquashfs $(GPSP_PKGDIR)/opk/gba $(TARGET_DIR)/usr/local/share/OPKs/Emulators/gba_gpsp_funkey-s.opk -all-root -noappend -no-exports -no-xattrs
endef
